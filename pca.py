...
def construct_pca(X_train, target_train, X_val, target_val, n_components, normalize = False, verbose = False):
...
def main():
    ...
    construct_pca(X_basic[train_indices, :], target_cont[train_indices],X_basic[val_indices], target_cont[val_indices], n_components = 2, normalize = True, verbose = True)
    # *** END CODE HERE ***
